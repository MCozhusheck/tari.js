...
import {
  ...
  TariPermissions,
} from "../../../src/providers/wallet_daemon/tari_permissions";

const SIGNALING_SERVER_URL = import.meta.env.VITE_SIGNALING_SERVER_ADDRESS || "http://localhost:18005";
...
walletDaemonPermissions.addPermission(new TariPermissionTransactionSend());
walletDaemonPermissions.addPermission(new TariPermissionSubstatesRead());
